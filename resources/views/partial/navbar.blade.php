        ...
        <div class="relative flex items-center justify-between h-16">
            ...
            <div class="flex items-center justify-center flex-1 sm:items-stretch sm:justify-start">
                <div class="flex items-center flex-shrink-0">
                    <a href="{{ route('home') }}">
                        <img width="90px" src="assets/img/logo-batik.png" alt="Logo">
                    </a>
                </div>
                <div class="hidden sm:ml-6 sm:block">
                    <div class="flex space-x-4">
                        <!-- Current: "bg-gray-900 text-white", Default: "text-gray-300 hover:bg-gray-700 hover:text-white" -->
                        <a href="#" class="px-3 py-2 text-sm font-medium text-white bg-blue-300 rounded-md"
                            aria-current="page">Home</a>
                        <a href="#"
                            class="px-3 py-2 text-sm font-medium text-gray-700 rounded-md hover:bg-blue-300 hover:text-white">Pemesanan</a>
                        <a href="#"
                            class="px-3 py-2 text-sm font-medium text-gray-700 rounded-md hover:bg-blue-300 hover:text-white">About</a>
                        {{-- <a href="#"
                            class="px-3 py-2 text-sm font-medium text-gray-700 rounded-md hover:bg-blue-300 hover:text-white">Calendar</a> --}}
                    </div>
                </div>
            </div>
