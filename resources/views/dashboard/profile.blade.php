...
@push('main-content')
    @section('style')
        <style>
            ...
            .avatar {
                width: 120px;
                /* Ukuran avatar yang lebih besar */
                height: 120px;
                border-radius: 50%;
            }
            ...
            .banner {
                width: 100%;
                height: 200px;
                /* Ukuran banner yang lebih besar */
                border-radius: 10px;
                object-fit: cover;
            }
        </style>
        ...
        <div class="container mt-3 p-4">
            <div style="margin-bottom: 50px">
                <div class="d-flex jusify-content-center align-items-center flex-column position-relative">
                    ...
                    <div class="mx-2 rounded-circle position-absolute border border-5 border-white"
                        style="width: 110px; height: 110px; overflow: hidden;top: 60%">
                        <img src="{{ asset('storage/' . $user->avatar) }}" alt="Avatar" class="avatar"
                            style="width: 100%; height: 100%; object-fit: cover;" class="img-fluid rounded-circle">
                    </div>
                </div>
            </div>
            ...
            <form action="{{ route('profile.update') }}" method="POST" enctype="multipart/form-data">
                ...
                <div>
                    <div class="w-100 mb-2 d-flex justify-content-center">
                        <span style="font-weight: bold; color: #74777a">ALAMAT</span>
                    </div>
                    <div class="d-flex w-100 gap-3">
                        <div class="form-group mb-4 w-100">
                            <label for="dusun">Dusun</label>
                            <input type="text" name="dusun" class="form-control" value="{{ $user->alamat->dusun }}">
                        </div>
                        <div class="form-group mb-4 w-100">
                            <label for="desa">Desa</label>
                            <input type="text" name="desa" class="form-control" value="{{ $user->alamat->desa }}">
                        </div>
                    </div>
                    <div class="d-flex w-100 gap-3">
                        <div class="form-group mb-4 w-100">
